...
class IMBALANCECIFAR100(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, imb_factor=None, rand_number=0, train=True,
        ...
        self.coarse_names, self.fine_to_coarse = self.load_coarse_labels_mapping('./datasets/cifar/fine2coarse.json')
        # for i in range(self.cls_num):
        #     print('class {:d}: {:d} : {}'.format(i, self.cls_num_list[i], self.classnames[i]))
